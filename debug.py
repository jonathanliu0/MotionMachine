...
STATES = [State(name='IDLE', id=0, devices={'master': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[])}), State(name='OFF', id=1, devices={'master': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[])}), State(name='MOTIONMACHINE', id=2, devices={'master': DeviceState(values=OrderedDict(), events=['goHome', 'stairsUp', 'stairsStop', 'openDoor', 'closeDoor', 'goUp', 'goUpWithBall']), 'tablet': DeviceState(values={}, events=[])})]
